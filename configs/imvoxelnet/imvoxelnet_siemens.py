...
data_root = 'mmdetection3d/data/siemens_factory/'
...
#         with_label=False),
#     dict(type='Collect3D', keys=['img'], meta_keys=['img_shape','cam2img','pad_shape','trans_mat','box_type_3d','box_mode_3d','img_norm_cfg'])
# ]
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root="",
            ann_file=data_root + 'siemens_train_mono3d.coco.json',
            info_file=data_root + 'siemens_train.pkl',
            # split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root="",
        ann_file=data_root + 'siemens_val_mono3d.coco.json',
        info_file=data_root + 'siemens_val.pkl',
        # split='training',
        # pts_prefix='velodyne_reduced',
